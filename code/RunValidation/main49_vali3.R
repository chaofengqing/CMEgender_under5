...
# main49_vali3.R
# 
# This script is the master file to get MCMC array for Validation.run. Run this
# script AFTER main49_vali1.R.
#
...
# 1. output/M49_vali/temp.JAGSobjects/ - stepwise JAGS trajectory output
#
###############################################################################
...
runID     <- 3 # defaults to 1 (set to 2,3, etc if you start several jobs) 
